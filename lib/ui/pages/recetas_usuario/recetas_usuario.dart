...
class RecetasUsuario extends StatefulWidget {
  ...
  static Widget init() => ChangeNotifierProvider(
        ...
        child: const RecetasUsuario._(),
      );

  @override
  State<RecetasUsuario> createState() => _RecetasUsuario();
}
...
class _RecetasUsuario extends State<RecetasUsuario> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: context.read<RecetasUsuarioProvider>().loadRecetas(),
